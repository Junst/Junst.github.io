...
export interface Publication {
  title: string
  authors: string       // HTML allowed (bold author = me)
  venue: string         // HTML allowed (e.g. with linked workshop name)
  awards?: string       // HTML allowed (e.g. "🏆 1st Place")
...
export const publications: PublicationGroup[] = [
  {
    category: 'Conference & Workshop Papers',
    items: [
      {
